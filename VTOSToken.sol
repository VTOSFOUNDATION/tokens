...
contract VTOSToken is IERC20 {

    using SafeMath for uint256;

    // Token properties
    string public name = "VTOS";
    string public symbol = "VTOS";
    uint public decimals = 18;

    uint public _totalSupply = 600000000e18;
    uint public _tokenLeft = 600000000e18;
    ...
    // Constructor
    // @notice VTOSToken Contract
    // @return the transaction address
    function VTOSToken() public payable {
        owner = msg.sender;
    ...
    function sendVTOSToken(address to, uint256 value) public onlyOwner {
        require (
    ...
    function sendVTOSTokenToMultiAddr(address[] listAddresses, uint256[] amount) onlyOwner {
    ...
    function destroyVTOSToken(address to, uint256 value) public onlyOwner {
        require (

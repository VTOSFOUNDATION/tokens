...
contract VCTToken is IERC20 {

    using SafeMath for uint256;

    // Token properties
    string public name = "VTOS Community Token";
    string public symbol = "VCT";
    uint public decimals = 18;

    uint public _totalSupply = 0e18;
    ...
    // Constructor
    // @notice VCTToken Contract
    // @return the transaction address
    function VCTToken() public payable {
        owner = msg.sender;
    ...
    function sendVCTToken(address to, uint256 value) public onlyOwner {
        require (
            to != 0x0 && value > 0
        );
    ...
    function sendVCTTokenToMultiAddr(address[] listAddresses, uint256[] amount) onlyOwner {
    ...
    function destroyVCTToken(address to, uint256 value) public onlyOwner {
        require (
                to != 0x0 && value > 0
            );
